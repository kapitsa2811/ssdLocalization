...
Original file is located at
    https://colab.research.google.com/drive/1EmFRh_57MTE0olPF_AjbdIf6LsvUHAE4
"""
...
def infer(net, epoch, background_threshold=0.9, device="cpu"):
    
    img = np.array(Image.open('./img/0.png').convert('RGB').resize((256, 256), Image.BILINEAR))
...
#def download_and_preprocess_data(dir = './data/pikachu/'): #batch_size,data_dir

def download_and_preprocess_data(batch_size,dir):
...
def save(model, path_to_checkpoints_dir, step, optimizer, loss):
    ...
    path_to_checkpoint = os.path.join(path_to_checkpoints_dir, 'model-{step}_{loss}.pth')
    checkpoint = {
